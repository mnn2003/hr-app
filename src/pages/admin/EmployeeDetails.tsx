...
import { Menu, ArrowLeft, Mail, Phone, MapPin, Briefcase, Calendar, FileText, Heart, GraduationCap, Users, Download } from 'lucide-react';
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="hidden sm:block">
                    <h1 className="text-sm font-semibold">Employee Details</h1>
